...
ENV=$(LMSDBHOST=111.222.111.222 LMSDBPORT=1234 LMSDBNAME=name LMSDBUSER=user LMSDBPASS=pass ALARMDBHOST=111.222.111.222 ALARMDBNAME=name ALARMDBUSER=user ALARMDBPASS=pass)
NODE=/usr/bin/node 
...
start() { 
  $ENV $NODE $SCRIPTNAME > $WORKDIR/log & 
  PID=$!
  $(echo $PID > $WORKDIR/pid)
